...
df = read_bom(FILES["BOM"])
Tc = read_csv(FILES["TC"])
IG = read_csv(FILES["IGNORE"])
...
validate_schema(df, BOM_SCHEMA, "BOM")
validate_schema(Tc, TC_SCHEMA, "TC")
validate_schema(IG, IGNORE_SCHEMA, "IGNORE")
